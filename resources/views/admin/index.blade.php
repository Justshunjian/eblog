...
@section('content')
	...
	<div class="top_box">
		...
		<div class="top_right">
			<ul>
				<li>管理员：{{session()->get('username')}}</li>
		...
		<ul>
			...
			<li>
				...
				<ul class="sub_menu" style="display: block;">
					...
					<li><a href="{{url('admin/config')}}" target="main"><i class="fa fa-fw fa-cog"></i>网站配置</a></li>
				</ul>
			</li>
			<li>
	...
	<div class="bottom_box">
		CopyRight © {{date('Y')}}. Powered By <a href="http://www.baidu.com" target="_blank">http://www.lvfk.com</a></p>
	</div>
	<!--底部 结束-->
