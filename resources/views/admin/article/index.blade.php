            ...
            <table class="list_tab">
                ...
                @foreach($data as $item)
                    <tr>
                        ...
                        <td class="tc">{{$item->art_title}}</td>
                        <td class="tc">{{$item->art_tag}}</td>
                        <td>
                            <img src="{{$item->art_thumb}}" width="100px" height="100px" align="center">
                        </td>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0)" name="delArticle" id="{{$item->art_id}}">删除</a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
