    ...
    <script>
        ...
        var bindlistener = function () {
            ...
            $(":text").change(function () {
                ...
                $.post('<?php echo e(url('admin/category/changeOrder')); ?>',{'_token':'<?php echo e(csrf_token()); ?>','id':cate_id, 'order':cate_order},function (data) {
...
//                            btn: [''] //按钮
            ...
            $("a[name='del']").click(function () {
                ...
                layer.confirm('您确定删除分类？', {
                    ...
                    $.post('<?php echo e(url('admin/category/')); ?>/'+cate_id,{'_token':'<?php echo e(csrf_token()); ?>','_method':'delete'},function (data) {
                        layer.closeAll('loading');
                        if(data.state){
                            //删除表格数据
...
//                            btn: [''] //按钮
        ...
        function pageUpDown(curr) {
            layer.load(2);
            $.post('<?php echo e(url('admin/category/page')); ?>',{'_token':'<?php echo e(csrf_token()); ?>','curr':curr, 'pageSize':10},function (data) {
                layer.closeAll('loading');
                if(data.state){
                    //操作表格
                    //清空所有子节点
