...
<?php $__env->startSection('content'); ?>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>静静设计-版本</label><span>v1.1</span>
                </li>
                <li>
                ...
                <li>
                    <label>Host</label><span><?php echo e($_SERVER['HTTP_HOST']); ?></span>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">http://www.lvfk.com</a></span>
                </li>
                <li>
                    <label>官方交流QQ群：</label><span>6417530811</span>
                </li>
            </ul>
        </div>
    </div>
